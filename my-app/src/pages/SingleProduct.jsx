            ...
            <div className="col-6">
              <div className="main-product-details">
                <div className="border-bottom">
                  <h3 className="title">
                    Áo Sơ Mi Dài Tay Từ Sợi Tre, Kháng Khuẩn, Bền Màu, Chống
                    Nhăn 6SMDS001DEN
                  </h3>
                </div>
                ...
                <div className="my-3 pb-3">
                  ...
                  <div className="d-flex gap-10 my-3 flex-column">
                    ...
                    <p className="product-data">
                      Áp dụng với khách hàng đã mua hàng tại hệ thống BiLuxury
                      do công ty trực tiếp quản lý <br />
                ...
                <div className="reviews mt-4">
                  <div className="review">
                    ...
                    <p className="mt-3">
                      ...
                      cupiditate incidunt eius facere aliquam? Possimus
                      reiciendis natus dolores expedita vitae ducimus corporis
                      deserunt cupiditate?
                    </p>
                  </div>
                </div>
